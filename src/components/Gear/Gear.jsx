    ...
    return (
        <section className="gear container">
            ...
            <div className='gear-buttons'>
                <Button mod='high' className={cn( { 'active': sortedType === "Gamepads" })} onClick={() => setSortedType('Gamepads')}>
                    Gamepads</Button>
                <Button mod='high' className={cn( { 'active': sortedType === "Keyboards" })} onClick={() => setSortedType('Keyboards')}>
                    Keyboards</Button>
                <Button mod='high' className={cn( { 'active': sortedType === "Gaming Mouse" })} onClick={() => setSortedType('Gaming Mouse')}>
                    Gaming Mouse</Button>
                <Button mod='high' className={cn( { 'active': sortedType === "Headphones" })} onClick={() => setSortedType('Headphones')}>
                    Headphones</Button>
            </div>
